                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-6 col-md-8 col-sm-10">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInUp" data-delay=".4s">BECOME A DIGITAL MARKETER</h1>
                                <P data-animation="fadeInUp" data-delay=".6s" >LEARN AND EARN MONEY WITH OUR EARNING ORIENTED DIGITAL MARKETING COURSES.</P>
                                <!-- Hero-btn -->
                                <div class="hero__btn">
                                    <a href="industries.html" class="btn hero-btn mb-10"  data-animation="fadeInUp" data-delay=".8s">REGISTER NOW</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-10">
                    <div class="about-caption mb-50">
                        ...
                        <div class="section-tittle mb-35">
                            <span></span>
                            <h2>YOU WANT TO DO SOMETHING, BUT NOT SURE WHAT?</h2>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-6 col-md-9">
                    ...
                    <div class="section-tittle section-tittle2 mb-50">
                        <h2 class="mb-35">THRIVE WITH US.</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,mod tempor incididunt ut labore et dolore magna aliqua. Utnixm, quis nostrud exercitation ullamc.</p>
                        <a href="#" class="btn  mt-30">Courses</a>
                    </div>
                </div>
                <div class="col-lg-5">
                   <div class="row">
                        ...
                        <div class="h1-testimonial-active">
                            ...
                            <div class="single-testimonial">
                                <div class="testimonial-caption">
                                    <p>With The help of this course, I am able to earn a handsome part time income for my wanderlust.</p>
                                    <div class="rattiong-caption">
                                        <span>Ishtiyaque Hussain<span>STUDENT</span> </span>
                                    </div>
                                </div>
                            </div>
                            <!-- Single Testimonial -->
                            <div class="single-testimonial">
                                <div class="testimonial-caption">
                                    <p>Unlike other courses in the market, Mandatorytrendz.com provides lots of practical knowledge and minimal theory.</p>
                                    <div class="rattiong-caption">
                                        <span>Parul Bakshi<span>STUDENT</span> </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-testimonial">
                                <div class="testimonial-caption">
                                    <p>MandatoryTrendz.com delivered what they promised. I would highly recommend this course if you want to earn money part time.</p>
                                    <div class="rattiong-caption">
                                        <span>Aakash Singh<span>STUDENT</span> </span>
                                    </div>
                                </div>
                            </div>
                        </div>
